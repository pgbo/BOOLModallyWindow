...
@interface BOOLModallyWindowAnimationContext : NSObject <BOOLModallyWindowContextAnimationing>
...
@implementation BOOLModallyWindowAnimationContext

@end

@interface BOOLModallyWindowRootVC : UIViewController
...
@implementation BOOLModallyWindowRootVC
...
@interface BOOLModallyWindow ()

@property (nonatomic) UIWindow *window;
@property (nonatomic) BOOLModallyWindowRootVC *windowRootVC;
...
@implementation BOOLModallyWindow
                             ...
                             windowEdgeInsets:(UIEdgeInsets)windowEdgeInsets
{
    if (self = [super init]) {
        ...
        [self setupModallyWindow];
    }
    return self;
}

- (void)setupModallyWindow
{
...
- (void)showWithAnimated:(BOOL)animated
{
    ...
    if (animated && self.modallyWindowAnimation) {
        
        BOOLModallyWindowAnimationContext *animationCtx = [[BOOLModallyWindowAnimationContext alloc]init];
        ...
        [self.modallyWindowAnimation animate:animationCtx];
    } else {
        [self didShow];
    }
}
...
- (void)didShow
{
    if (self.modallyWindowDelegate
        && [self.modallyWindowDelegate respondsToSelector:@selector(modallyWindowDidShow:)]) {
        [self.modallyWindowDelegate modallyWindowDidShow:self];
    }
}
...
{
    if (self.modallyWindowDelegate
        && [self.modallyWindowDelegate respondsToSelector:@selector(modallyWindowDidDismiss:)]) {
        [self.modallyWindowDelegate modallyWindowDidDismiss:self];
    }
}
